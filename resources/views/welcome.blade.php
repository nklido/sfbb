...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    ...
    <body class="antialiased">
        ...
        <div class="container mt-8">
            ...
            <form action="ftth/refresh" method="POST">
                @csrf
            ...
            @if(Request::get('postal_code'))
                ...
                src="https://www.google.com/maps/embed/v1/search?key=AIzaSyCDQBvyBJyM7tbnFckDPRk-HprR-VjF-M8&q=Athens+{{Request::get('postal_code')}}" allowfullscreen>
            </iframe>
            @endif
                    ...
                    <tr>
                        ...
                        <td>
                            @if($number->street->cosmote_street_name)
                                <button data-number-id="{{$number->id}}" class="cosmote-availability-check btn btn-light">
                                    check 
                                </button>
                            @endif
                        </td>
